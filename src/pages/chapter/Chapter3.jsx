...
import jobBanner from "../../assets/job.jpg";
    ...
    <div className="max-w-5xl mx-auto px-4 py-8 text-slate-100">
      ...
      <header className="mb-6 md:mb-8">
        ...
        <div className="mb-4 overflow-hidden rounded-2xl border border-slate-700 bg-slate-900">
          <img
            src={jobBanner}
            alt="Job interview between candidate and interviewer"
        ...
        <p className="mt-2 text-slate-300">
          Find roles that fit you, research companies, and face interviews with confident
          communication and clear examples.
        </p>
      ...
      <SectionCard tone="amber" title="Job interview basics">
        <p className="mb-2">
          An interview is a two-way conversation to check fit. You show evidence of skills; they
          show the role and environment.
        </p>
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>
            Prepare examples using <span className="font-semibold">STAR</span> (Situation, Task,
            Action, Result).
          </li>
        </ul>
      </SectionCard>
      ...
      <div className="grid md:grid-cols-2 gap-4 my-6">
        <SectionCard title="Non-verbal &amp; verbal communication" tone="emerald">
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              Practice active listening: pay attention, show you’re listening, clarify if needed,
              avoid rushing to judge, respond appropriately.
            </li>
          </ul>
        </SectionCard>
        <SectionCard title="6/7 Cs for answers" tone="slate">
          <ul className="list-disc pl-5 space-y-1">
            <li>
              ...
              <span className="font-semibold">Concise</span>: get to the point.
            </li>
            <li>
              <span className="font-semibold">Correct</span> &amp;{" "}
              <span className="font-semibold">Complete</span>: facts + needed details.
            </li>
            <li>
              <span className="font-semibold">Concrete</span>: examples, outcomes, numbers.
            </li>
            <li>
              <span className="font-semibold">Courteous/Confident</span>: polite tone, positive
              attitude.
            </li>
          </ul>
        </SectionCard>
      ...
      <SectionCard tone="cyan" title="What successful candidates do">
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>
            Answer with specifics and support claims; ask good questions; speak more than
            interviewer(s) without rambling.
          </li>
        </ul>
      </SectionCard>
      ...
      <div className="grid md:grid-cols-2 gap-4 my-6">
        ...
        <SectionCard title="Example STAR answer (challenge)" tone="emerald">
          <p className="mb-1">
            <span className="font-semibold">S/T:</span> Project was behind; client deadline 5PM;
            lead unavailable.
          </p>
          <p className="mb-1">
            <span className="font-semibold">A:</span> I coordinated 4 teammates by strengths,
            focused my day on key tasks, kept client updated.
          </p>
          <p>
            <span className="font-semibold">R:</span> Delivered on time; later trusted to lead more
            projects. Shows leadership and time management.
          </p>
        </SectionCard>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-4 my-6">
        <SectionCard title="Activity – Mock interview (pair/group)" tone="cyan">
          <ul className="list-disc pl-5 space-y-1 text-sm">
            ...
            <li>
              Rate 1–5 on non-verbal (eye contact, posture, tone) and verbal (clarity, examples).
            </li>
        ...
        <SectionCard title="Activity – Q lists" tone="cyan">
          <ul className="list-disc pl-5 space-y-1 text-sm">
            <li>
              Make two lists: (1) possible interviewer questions, (2) questions you will ask the
              interviewer.
            </li>
      ...
      <SectionCard tone="emerald" title="My Self-Reflection (Chapter 03)">
        <p>
          I learned how to prepare focused answers with STAR and how non-verbal cues affect first
          impressions. I will research each company, prepare 3 example stories, and practice active
          listening. In the next mock interview, I will slow down, keep eye contact, and ask 2
          thoughtful questions at the end.
        </p>
      </SectionCard>
    </div>
  );
