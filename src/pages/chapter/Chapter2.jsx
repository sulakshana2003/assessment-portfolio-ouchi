...
import cvBanner from "../../assets/cv.jpg";
...
const chipTone = {
  wrapper:
    "inline-flex items-center gap-2 rounded-full border px-3 py-1 text-sm font-medium border-emerald-500 bg-emerald-900/60 text-emerald-50",
    ...
    <div className="max-w-5xl mx-auto px-4 py-8 text-slate-100">
      ...
      <header className="mb-6 md:mb-8">
        ...
        <div className="mb-4 overflow-hidden rounded-2xl border border-slate-700 bg-slate-900">
          <img
            src={cvBanner}
            alt="Illustration of CV and candidate selection"
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-6">
        <SectionCard tone="cyan" title="What is a CV?">
          <p>
            A CV (Curriculum Vitae) is a formal 1–2 page document showing
            education, experience, skills, and achievements. It helps recruiters
            see your fit quickly. A resume is usually shorter and more
            condensed; some countries use the terms differently.
          </p>
        </SectionCard>
      ...
      <SectionCard tone="amber" title="CV Structure (common order)">
        <ol className="list-decimal pl-5 space-y-1">
          <li>
            ...
            city; optional LinkedIn/GitHub/portfolio.
          </li>
          <li>
            <span className="font-semibold">Profile / Summary:</span> 2–3 lines
            on strengths and goals tailored to the role.
          </li>
          <li>
          ...
          <li>
            ...
            year, key coursework (optional).
          </li>
          <li>
            <span className="font-semibold">Skills:</span> technical + soft
            skills; be honest on levels.
          </li>
          <li>
            <span className="font-semibold">Projects / Achievements:</span>{" "}
            brief bullets with outcomes/metrics.
          </li>
          <li>
      ...
      <div className="grid md:grid-cols-2 gap-4 my-6">
        ...
        <SectionCard title="CV – Avoid" tone="slate">
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              Irrelevant personal data (NIC, marital status, photo) unless
              asked.
            </li>
      ...
      <SectionCard tone="cyan" title="Cover Letter: purpose &amp; structure">
        <p>
          A cover letter introduces your CV and shows why you fit this specific
          role. Keep to one page.
        </p>
        <ol className="list-decimal pl-5 mt-2 space-y-1">
          ...
          <li>
            <span className="font-semibold">Opening:</span> role you’re applying
            for + where you saw it + a focused hook.
          </li>
          <li>
            <span className="font-semibold">Fit paragraph:</span> 1–2
            achievements that match the job’s needs.
          </li>
          <li>
            <span className="font-semibold">Why them:</span> show research;
            align with their goals/products.
          </li>
          <li>
            <span className="font-semibold">Close:</span> call-to-action,
      ...
      <div className="grid md:grid-cols-2 gap-4 my-6">
        ...
        <SectionCard title="Activity – Cover Letter (Gap-fill)" tone="slate">
          <p className="mb-2">
            Practice with words like: advertised, candidate, contribute, apply,
            enclosed, opportunity.
          </p>
      ...
      <SectionCard tone="emerald" title="My Self-Reflection (Chapter 02)">
        <p>
          ...
          with numbers. I will tailor my CV for each job and keep a simple
          design. For cover letters, I will mention the role, show 1–2 strong
          matches, and explain why I want that company. My next step is to
          update my CV with recent projects and ask a friend to review it.
        </p>
      </SectionCard>
    </div>
  );
