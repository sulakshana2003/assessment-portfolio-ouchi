...
import proposalBanner from "../../assets/prop.jpg";
    ...
    <div className="max-w-5xl mx-auto px-4 py-8 text-slate-100">
      ...
      <header className="mb-6 md:mb-8">
        ...
        <div className="mb-4 overflow-hidden rounded-2xl border border-slate-700 bg-slate-900">
          <img
            src={proposalBanner}
            alt="People discussing and writing a project proposal"
        ...
        <p className="mt-2 text-slate-300">
          Write a clear proposal (problem → objectives → activities → budget → results) and evaluate
          your project after it ends.
        </p>
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-6">
        <SectionCard tone="cyan" title="What is a project?">
          <p>
            A project is a set of activities with a goal, a timeline, a team, and resources. It moves
            through a cycle: idea → design → finance → implement → evaluate.
          </p>
        </SectionCard>
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-6">
        <SectionCard tone="amber" title="External vs Internal proposals">
          <ul className="list-disc pl-5 space-y-1">
            <li>
              <span className="font-semibold">External</span> – bids for contracts/grants. Usual
              parts: Executive summary, Management, Financials.
            </li>
            <li>
              <span className="font-semibold">Internal</span> – convince your organisation to accept
              an idea. Focus on audience, visuals, and the 4Qs: What’s the problem? Solution?
              Can/Should we implement?
            </li>
          </ul>
        </SectionCard>
      ...
      <SectionCard tone="emerald" title="Proposal structure (simple template)">
        <ol className="list-decimal pl-5 space-y-1">
          <li>
            <span className="font-semibold">Title &amp; Abstract</span> – problem, objectives,
            activities, budget snapshot.
          </li>
          <li>
            <span className="font-semibold">Context &amp; Justification</span> – data and why it
            matters.
          </li>
          <li>
            <span className="font-semibold">Problem → Objectives</span> – goal (one), objectives
            (measurable), target group.
          </li>
          <li>
            <span className="font-semibold">Methods &amp; Activities</span> – what you will do.
          </li>
          <li>
            <span className="font-semibold">Implementation plan</span> – timeline, responsibilities,
            milestones.
          </li>
          <li>
            <span className="font-semibold">Resource plan &amp; Budget</span> – direct vs operational
            costs; income if any.
          </li>
          <li>
            <span className="font-semibold">Management &amp; Team</span> – roles, partners, capacity.
          </li>
          <li>
            <span className="font-semibold">Monitoring &amp; Evaluation (M&amp;E)</span> – indicators,
            data, reporting.
          </li>
          <li>
            <span className="font-semibold">Annexes</span> – CVs, data tables, charts, forms.
          </li>
        </ol>
      </SectionCard>
      ...
      <div className="grid md:grid-cols-2 gap-4 my-6">
        <SectionCard tone="cyan" title="Activity plan (mini table)">
          <div className="overflow-x-auto">
            <table className="w-full text-left border border-slate-600 rounded-lg text-sm">
          ...
          <p className="text-xs mt-2 text-slate-300">
            Tip: A Gantt chart can show overlaps and dependencies.
          </p>
        </SectionCard>
        <SectionCard tone="amber" title="Resource plan (cost sketch)">
          ...
          <p className="text-xs mt-2 text-slate-300">
            Include both direct costs (linked to activities) and operational costs (overheads).
          </p>
        </SectionCard>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-4 my-6">
        <SectionCard title="Indicators (make them specific)" tone="slate">
          <ul className="list-disc pl-5 space-y-1 text-sm">
            <li>
              Quality (what changes), Target group (who), Place (where), Quantity (how much), Time
              (by when).
            </li>
            <li>
              Example: “Ticket sales reach 500 by 18 Oct; satisfaction score ≥ 4/5.”
            </li>
          </ul>
        </SectionCard>
      ...
      <SectionCard tone="cyan" title="Evaluation report (Food-fest style)">
        <ol className="list-decimal pl-5 space-y-1">
          <li>
            <span className="font-semibold">Executive summary</span> – objectives, results, key
            takeaways.
          </li>
          <li>
            <span className="font-semibold">Objectives &amp; goals</span> – what you aimed to
            achieve.
          </li>
          <li>
            <span className="font-semibold">Planning process</span> – roles, timeline, prep.
          </li>
          <li>
            <span className="font-semibold">Execution</span> – what happened, challenges.
          </li>
          <li>
            <span className="font-semibold">Budget</span> – estimated vs actual, revenue,
            profit/loss.
          </li>
          <li>
            <span className="font-semibold">Lessons learned</span> – what to change next time.
          </li>
          <li>
            <span className="font-semibold">Recommendations</span> – practical improvements.
          </li>
          <li>
            <span className="font-semibold">Conclusion</span> – overall success and impact.
          </li>
        </ol>
      </SectionCard>
      ...
      <SectionCard tone="emerald" title="My Self-Reflection (Chapter 06)">
        <p>
          I learned to connect problem → objectives → activities → budget, and to measure results with
          clear indicators. For the next project, I will write a one-page proposal first, build an
          activity/resource plan, and keep all receipts and survey data for a strong evaluation report.
          I will compare estimated vs actual budget and list 3 lessons learned with actions for
          improvement.
        </p>
      </SectionCard>
    </div>
